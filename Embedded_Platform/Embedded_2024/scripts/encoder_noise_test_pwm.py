...
def main() -> None:
    ...
    ap.add_argument("--cmd", type=float, default=20, help="Commanded speed [cm/s]")
    ap.add_argument("--pwm", type=float, default=-1, help="Commanded pwm")
    ap.add_argument("--dur", type=float, default=12, help="Duration [s]")
    ap.add_argument("--steer", type=float, default=20, help="Commanded steering in deg")
