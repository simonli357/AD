...
class WaypointsSrvResponse : public Encoder {
  public:
	WaypointsSrvResponse(uint8_t &data_type, Float32MultiArray &state_refs, Float32MultiArray &input_refs, Float32MultiArray &wp_attributes, Float32MultiArray &wp_normals);
	WaypointsSrvResponse(WaypointsSrvResponse &&) = default;
	WaypointsSrvResponse(const WaypointsSrvResponse &) = default;
	WaypointsSrvResponse &operator=(WaypointsSrvResponse &&) = delete;
	WaypointsSrvResponse &operator=(const WaypointsSrvResponse &) = delete;
	~WaypointsSrvResponse() = default;
