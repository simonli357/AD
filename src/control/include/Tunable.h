...
namespace Tunable {
    ...
    inline int lane_relocalize2_consecutive_frames = 1;
    inline double lane_relocalize2_max_error_spread = 0.03;
    inline double lane_relocalize2_post_sign_cooldown = 0.0;
    ...
    //   std::string mode = real ? "/real" : "/sim";
      ...
      CHECK_PARAM(mode + "/lane_relocalize2_consecutive_frames", lane_relocalize2_consecutive_frames);
      CHECK_PARAM(mode + "/lane_relocalize2_max_error_spread", lane_relocalize2_max_error_spread);
      CHECK_PARAM(mode + "/lane_relocalize2_post_sign_cooldown", lane_relocalize2_post_sign_cooldown);
