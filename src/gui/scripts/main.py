...
class MainWindow(QMainWindow):
    def __init__(self, server):
        ...
        self.meter_wrapper_layout = QVBoxLayout(meter_wrapper)
        self.meter_wrapper_layout.setAlignment(QtCore.Qt.AlignCenter)
        self.meter_wrapper_layout.addWidget(self.meter_widget)
