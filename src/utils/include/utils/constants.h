...
namespace VehicleConstants {
    ...
    static constexpr std::array<double, 6> REALSENSE_TF = {-0.090, -0.032, 0.260, 1.0*M_PI/180.0, 1.85*M_PI/180.0, 0.0*M_PI/180.0}; // x, y, z, roll, pitch, yaw
    static constexpr std::array<double, 6> REALSENSE_TF_REAL = {-0.090, -0.032, 0.260, 1.0*M_PI/180.0, 1.85*M_PI/180.0, 0.0*M_PI/180.0};
