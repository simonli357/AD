...
namespace VehicleConstants {
    ...
    static const std::vector<std::vector<double>> SOUTH_FACING_INTERSECTIONS = {
        {{15.46-ofs6, 4.58-hsw, -M_PI/2}},
        {{15.165376+ofs6, 1.4972-hsw, -M_PI/2}},
        {{4.9156-ofs6, 4.581664-hsw, -M_PI/2}},
        {{4.9143-ofs6, 1.3-hsw, -M_PI/2}},
        {{2.667-ofs6, 1.3-hsw, -M_PI/2}},
        {{2.67-ofs6, 4.584-hsw, -M_PI/2}},
        {{0.50684-ofs6, 4.5849-hsw, -M_PI/2}},
        {{0.50684-ofs6, 7.470675-hsw, -M_PI/2}},
        {{0.50684-ofs6, 10.584-hsw, -M_PI/2}},
        // roundabout intersections
        {{16.075438-ofs6, 11.684077-hsw, -M_PI/2}},
        // crosswalk intersections
        {{15.3, 3, -M_PI/2}},
        {{4.75, 7.92, -M_PI/2}},
    };
    static const std::vector<std::vector<double>> NORTH_FACING_INTERSECTIONS = {
        {{0.579612+ofs6, 9.0727+hsw, M_PI/2}},
        {{0.579612+ofs6, 5.96247+hsw, M_PI/2}},
        {{0.579612+ofs6, 3.07145+hsw, M_PI/2}},
        {{2.744851+ofs6, 3.07145+hsw, M_PI/2}},
        {{2.744851+ofs6, 5.9603+hsw, M_PI/2}},
        {{4.9887+ofs6, 5.958+hsw, M_PI/2}},
        {{4.9887+ofs6, 3.07+hsw, M_PI/2}},
        {{6.77784-ofs6, 3.44261+hsw, M_PI/2}},
        // roundabout intersections
        {{16.104+ofs6, 9.5053+hsw, M_PI/2}},
        // crosswalk intersections
        {{17.11, 2.367, M_PI/2}},
        {{5.15, 7.38, M_PI/2}},
    };
    static const std::vector<std::vector<double>> WEST_FACING_INTERSECTIONS = {
        {{1.296-hsw, 3.86375+ofs6, M_PI}},
        {{3.4543-hsw, 3.865637+ofs6, M_PI}},
        {{5.71-hsw, 3.8661+ofs6, M_PI}},
        {{5.708-hsw, 6.753+ofs6, M_PI}},
        {{3.4547-hsw, 6.7545+ofs6, M_PI}},
        {{1.296-hsw, 6.754754+ofs6, M_PI}},
        {{7.568552-hsw, 3.8674+ofs6, M_PI}},
        {{3.45624-hsw, 0.58153+ofs6, M_PI}},
        {{16.2485-hsw, 3.8678+ofs6, M_PI}},
        // roundabout intersections
        {{17.1571-hsw, 10.633+ofs6, M_PI}},
        // crosswalk intersections
        {{9.5, 4, M_PI}},
        {{1.74, 10, M_PI}},
    };
    static const std::vector<std::vector<double>> EAST_FACING_INTERSECTIONS = {
        {{1.95075+hsw, 0.503891-ofs6, 0}},
        {{1.95075+hsw, 3.794-ofs6, 0}}, 
        {{1.95+hsw, 6.6816-ofs6, 0}}, 
        {{4.19476+hsw, 6.681-ofs6, 0}}, 
        {{4.19476+hsw, 3.79216-ofs6, 0}}, 
        {{4.194644+hsw, 0.503836-ofs6, 0}}, 
        // {{6.0735+hsw, 0.5949+ofs6}}, 
        {{14.7386+hsw, 1.07135-ofs6, 0}}, 
        // roundabout intersections
        {{14.983+hsw, 10.5538-ofs6, 0}},
        // crosswalk intersections
        {{8.2, 0.92, 0}},
        {{1.22, 9.62, 0}},
    };
    ...
    static constexpr std::array<double, 6> REALSENSE_TF = {-0.113, 0.0, 0.2573, 0, 0.2617, 0}; // x, y, z, roll, pitch, yaw
    static constexpr std::array<double, 6> REALSENSE_TF_REAL = {-0.113, 0.0, 0.2573, 0, 0.2617, 0};
